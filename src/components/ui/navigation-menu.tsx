...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-full data-[motion^=from-]:animate-in data-[motion^=to-]:fade-out data-[motion^=from-]:fade-in data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 data-[motion^=from-]:zoom-in-90 data-[motion^=to-]:zoom-out-95 md:absolute md:w-auto",
      className
    )}
    {...props}
  />
...
interface NavigationMenuListItemProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
  title: string
  icon?: React.ReactNode
  description?: string
  asChild?: boolean
...
>(({ className, title, icon, description, asChild = false, ...props }, ref) => {
  const content = (
